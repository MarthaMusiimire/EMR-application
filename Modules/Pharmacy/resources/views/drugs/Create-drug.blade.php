     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="drug_name"  minlength='2' class="form-control" placeholder="Drug Name" value="{{old('drug_name')}}">
            </div> 
        </div>
        ...
        <div class="form-group">
                ...
                <input type="text" name="brand_name"  minlength='2' class="form-control" placeholder="Brand Name" value="{{old('last_name')}}">
            </div>
        </div>

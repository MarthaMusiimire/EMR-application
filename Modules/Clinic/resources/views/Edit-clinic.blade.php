        ...
        <div class="col-md-6 col-lg-6"> <!-- Adjust the column size based on how narrow you want the form -->
            <div class="card">
                <div class="card-header text-center">
                    <h4>{{ isset($clinic) ? 'Edit Clinic' : 'Create Clinic' }}</h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ isset($clinic) ? route('clinics.update', $clinic->id) : route('clinics.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="clinic_name" id="clinic_name" class="form-control" value="{{ old('clinic_name', $clinic->clinic_name ?? '') }}" required>
                        </div>

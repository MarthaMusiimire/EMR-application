                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('diagnoses.update', $diagnosis->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="diagnosis_name" id="diagnosis_name" class="form-control" value="{{ $diagnosis->diagnosis_name }}" required>
                        </div>

                        <div class="form-group">
                            <label for="icd_code">ICD-CODE 11</label>
                            <input type="text" name="icd_code" id="icd_code" class="form-control" value="{{ $diagnosis->icd_code }}" required>
                        </div>
